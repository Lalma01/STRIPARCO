'use strict';
// Shared renderer translations for ContentBlocker (English / Hungarian).
(function () {
  const DICT = {
    hu: {
      // index
      app_name: 'ContentBlocker',
      ...
      // settings
      set_title: 'Beállítások – ContentBlocker', set_h1: '⚙ Beállítások',
      ...
      lang_h2: '🌐 Nyelv / Language', lang_label: 'Felület nyelve:', close_btn: 'Bezárás',
      // screentime
      st_title: 'Képernyőidő – ContentBlocker', st_h1: '⏱ Képernyőidő', st_sub: 'Napi képernyőidő-korlát',
      ...
      bl_p: 'A kért weboldal sérti a ContentBlocker biztonsági házirendjét (NSFW tartalom), ezért a hozzáférést letiltottuk.',
      bl_shield: 'ContentBlocker Aktív Védelem',
      // notification
      nt_title: 'TARTALOM BLOKKOLVA', nt_body: 'A böngésző tiltott tartalmat jelenített meg.', nt_reason: 'Indok: ',
    },
    en: {
      app_name: 'ContentBlocker',
      ...
      set_title: 'Settings – ContentBlocker', set_h1: '⚙ Settings',
      ...
      lang_h2: '🌐 Language / Nyelv', lang_label: 'Interface language:', close_btn: 'Close',
      st_title: 'Screen Time – ContentBlocker', st_h1: '⏱ Screen Time', st_sub: 'Daily screen time limit',
      ...
      bl_p: 'The requested website violates the ContentBlocker security policy (NSFW content), so access has been blocked.',
      bl_shield: 'ContentBlocker Active Protection',
      nt_title: 'CONTENT BLOCKED', nt_body: 'The browser displayed blocked content.', nt_reason: 'Reason: ',
    },
  };
